...
REQUIRED_FILES = [
    ...
    "scripts/check_external_event_sources.py",
    ...
    "docs/development.md",
    "docs/external_event_ingestion.md",
    ...
    "src/market_relay_engine/context/external_classification.py",
    "src/market_relay_engine/context/external_event_archive.py",
    "src/market_relay_engine/context/external_normalization.py",
    "src/market_relay_engine/context/external_source_config.py",
    "src/market_relay_engine/context/external_sources.py",
    "src/market_relay_engine/context/veritawire.py",
    ...
    "tests/unit/test_external_classification.py",
    "tests/unit/test_external_event_archive.py",
    "tests/unit/test_external_event_source_checker.py",
    "tests/unit/test_external_normalization.py",
    "tests/unit/test_external_research_projection.py",
    "tests/unit/test_external_sources.py",
    "tests/unit/test_veritawire.py",
    "tests/integration/test_external_event_ingestion_pilot.py",
